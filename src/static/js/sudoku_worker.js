onmessage = function(msg) {
    ...
    while (num_index < 81) {
        ...
        if (num_index === end_index) {
            ...
            new_array_flat[num_index] = new_array[parseInt(num_index/9)][num_index%9];
            postMessage(new_array_flat);
        }
    ...
    postMessage("Mr. Stark I don't feel so good")
}